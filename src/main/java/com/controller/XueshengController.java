...
public class XueshengController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengEntity xuesheng,
		...
		if(tableName.equals("xuesheng")) {
			xuesheng.setXueshengxuehao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R save(@RequestBody XueshengEntity xuesheng, HttpServletRequest request){
        if(xueshengService.selectCount(new EntityWrapper<XueshengEntity>().eq("xueshengxuehao", xuesheng.getXueshengxuehao()))>0) {
    ...
    public R update(@RequestBody XueshengEntity xuesheng, HttpServletRequest request){
        //ValidatorUtils.validateEntity(xuesheng);
        if(xueshengService.selectCount(new EntityWrapper<XueshengEntity>().ne("id", xuesheng.getId()).eq("xueshengxuehao", xuesheng.getXueshengxuehao()))>0) {
            return R.error("学生学号已存在");
        }
