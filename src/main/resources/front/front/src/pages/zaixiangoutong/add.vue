...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="沟通人账号" prop="goutongrenzhanghao">
            <el-input v-model="ruleForm.goutongrenzhanghao" 
                placeholder="沟通人账号" clearable :disabled=" false  ||ro.goutongrenzhanghao"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="沟通人姓名" prop="goutongrenxingming">
            <el-input v-model="ruleForm.goutongrenxingming" 
                placeholder="沟通人姓名" clearable :disabled=" false  ||ro.goutongrenxingming"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="联系标题" prop="lianxibiaoti">
            <el-input v-model="ruleForm.lianxibiaoti" 
                placeholder="联系标题" clearable :disabled=" false  ||ro.lianxibiaoti"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="联系时间" prop="lianxishijian">
              <el-date-picker
				  :disabled=" false  ||ro.lianxishijian"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="联系内容" prop="lianxineirong">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="联系内容"
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`zaixiangoutong/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
			...
			this.$refs["ruleForm"].validate(valid => {
				if(valid) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('zaixiangoutong/list', {
							params: params
						}).then(res => {
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`zaixiangoutong/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
