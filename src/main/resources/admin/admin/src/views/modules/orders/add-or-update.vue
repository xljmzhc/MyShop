	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商户名称" prop="xueshengxuehao">
					<el-input v-model="ruleForm.xueshengxuehao" placeholder="商户名称" clearable  :readonly="ro.xueshengxuehao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="商户名称" prop="xueshengxuehao">
					<el-input v-model="ruleForm.xueshengxuehao" placeholder="商户名称" readonly></el-input>
				</el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../MyShop/upload');
        } else {
