<template>
	<div class="main-content" :style='{"padding":"30px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('shangpinxinxi','在线沟通')" @click="zaixiangoutongCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
								在线沟通
							</el-button>
							<el-button class="btn8" v-if="isAuth('shangpinxinxi','投诉')" @click="tousuxinxiCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
								投诉
							</el-button>
		...
		<zaixiangoutong-cross-add-or-update v-if="zaixiangoutongCrossAddOrUpdateFlag" :parent="this" ref="zaixiangoutongCrossaddOrUpdate"></zaixiangoutong-cross-add-or-update>
...
import zaixiangoutongCrossAddOrUpdate from "../zaixiangoutong/add-or-update";
	...
	export default {
		data() {
			return {
				...
				zaixiangoutongCrossAddOrUpdateFlag: false,
		...
		components: {
			AddOrUpdate,
			zaixiangoutongCrossAddOrUpdate,
		...
		methods: {
			...
			zaixiangoutongCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.zaixiangoutongCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.zaixiangoutongCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.zaixiangoutongCrossaddOrUpdate.init(row.id,type);
				});
			},
